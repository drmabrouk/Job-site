            ...
            $.post(jobs_vars.ajax_url, data, function(response) {
                if(response.success) {
                    ...
                    var newHtml = '<div class="chat-message me" style="margin-bottom: 15px; text-align: right;">' +
                                  '<div class="msg-bubble" style="display: inline-block; padding: 10px 15px; border-radius: 15px; background: var(--jobs-primary-color); color: white; max-width: 80%;">' + msg + '</div>' +
