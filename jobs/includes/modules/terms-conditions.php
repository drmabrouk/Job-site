...
<div class="jobs-module-content">
    ...
    <div class="terms-container" style="background: white; padding: 40px; border-radius: 12px; margin-top: 20px; color: #555; line-height: 1.8;">
        ...
        <p>The platform acts as a bridge between employers and job seekers. We are not liable for any disputes arising from employment contracts or recruitment processes.</p>
    </div>
</div>
